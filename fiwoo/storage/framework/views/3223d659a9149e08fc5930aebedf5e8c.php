    ...
    <html lang="es">
      ...
      <body class="shock-body">
        ...
        <div id="preloader" class="preloader white" data-delay="0" data-limit="3000">
          <img src="<?php echo e(URL::asset('assets/images/logo-gradient.svg')); ?>" class="emblem" alt="Emblem" />
        </div>
        ...
        <div id="popup-bar" class="popup-bar bg-gradient scheme-1 shadow d-none">
          ...
          <a href="<?php echo e(url('account')); ?>" target="_blank" class="button simple">
                        ...
                        <ul class="navbar-nav">
                          <li class="nav-item dropdown hover">
                            ...
                            <ul class="dropdown-menu animate fade-down">
                              <li class="nav-item">
                                <a href="<?php echo e(url('en')); ?>" class="nav-link">
                    ...
                    <div class="navbar-bottom">
                      ...
                      <div id="navbar-items" class="collapse navbar-collapse">
                                  ...
                                  <li class="nav-item">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                      <div class="megamenu-item side-image">
                                        <a href="<?php echo e(url('account')); ?>" target="_blank" class="megamenu-image black">
                        ...
                        <div class="navbar-nav navbar-action">
                          <div class="nav-item">
                            <a href="<?php echo e(url('account')); ?>" target="_blank" class="button small-button rounded primary-15 primary-hover button-collision">
              ...
              <div class="row g-4">
                <div class="col-12 col-md-6 col-lg-4" data-aos="zoom-in-up" data-aos-delay="200">
                  <div class="card has-price rounded shadow parent">
                    ...
                    <!-- Link -->
                    <a href="<?php echo e(url('account')); ?>" class="full-link"></a>
                  </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4" data-aos="zoom-in-up" data-aos-delay="400">
                  <div class="card has-price rounded shadow parent">
...
<?php /**PATH C:\xampp\htdocs\Management_System_App\fiwoo\resources\views/index.blade.php ENDPATH**/ ?>