...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/vendor/font-awesome.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/vendor/menu-engine.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/vendor/menu-grid.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/vendor/bootstrap.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/vendor/swiper.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/vendor/dynamic-slider.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/vendor/bricklayer.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/vendor/lightbox.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/vendor/aos.min.css')); ?>" />

    <!-- Main Style Sheet -->
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/theme.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/core.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/main.css')); ?>" />

     <!-- Vendor JavaScript -->
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/jquery.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/imagesloaded.pkgd.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/preloader.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/inview.min.js ')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/menu-engine.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/menu-grid.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/bootstrap.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/swiper.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/anime.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/dynamic-slider.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/shuffle.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/stickybits.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/bricklayer.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/lightbox.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/typed.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/progressbar.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/map-styles.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/magnetic-effect.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/gsap.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/aos.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/lax.min.js')); ?>"></script>
    <script defer src="<?php echo e(URL::asset('assets/js/vendor/cursor-effect.min.js')); ?>"></script>

    <!-- Main JavaScript -->
    <script defer src="<?php echo e(URL::asset('assets/js/main.js')); ?>"></script>
  ...
  <body class="shock-body">
    ...
    <div id="popup-bar" class="popup-bar bg-gradient scheme-1 shadow d-none">
      ...
      <a href="<?php echo e(url('account-en')); ?>" target="_blank" class="button simple">
                    ...
                    <ul class="navbar-nav">
                      <li class="nav-item dropdown hover">
                        <a href="#" class="nav-link dropdown-toggle has-icon" data-bs-toggle="dropdown" aria-expanded="false">
                          ...
                          <span class="text">English</span><img class="image-icon dropdown-icon" src="assets/svg/chevron-down-outline.svg" alt="Icon name" data-shock-icon="32" />
                        </a>
              ...
              <div class="container">
                <div class="navbar-bottom">
                  ...
                  <a class="navbar-brand" href="/">
                    ...
                    <img src="<?php echo e(URL::asset('assets/images/logo.svg')); ?>" data-logo-alt="<?php echo e(URL::asset('assets/images/logo.svg')); ?>" data-logo-mobile="<?php echo e(URL::asset('assets/images/logo.svg')); ?>" alt="Shock Theme" class="logo" />
                  ...
                  <div id="navbar-items" class="collapse navbar-collapse">
                        ...
                        <form class="form-fields needs-validation" novalidate="novalidate">
                          <div class="form-row row has-icon">
                            <div class="form-col form-floating">
                              <button class="button overlay-button"><img class="overlay-image-icon" src="<?php echo e(URL::asset('assets/svg/send-outline.svg')); ?>" alt="Icon name" data-shock-icon="32" /></button>
                              <input id="InputSearchMobile" class="form-control focus-trigger-field" name="InputSearchMobile" placeholder="Search Engine..." required="required">
                              <label for="InputSearchMobile" class="form-label">Search Engine...</label>
                            </div>
                          </div>
                        </form>
                      </div>
                    ...
                    <ul class="navbar-nav ms-auto">
                      <li class="nav-item dropdown has-megamenu hover">
                        <a class="nav-link dropdown-toggle has-icon flutter-underline" href="#" data-bs-toggle="dropdown">
                          <span class="text">Fiwoo App</span><img class="image-icon dropdown-icon" src="<?php echo e(URL::asset('assets/svg/chevron-down-outline.svg')); ?> " alt="Icon name" data-shock-icon="32" />
                              ...
                              <li class="nav-item">
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                  <div class="megamenu-item side-image">
                                    <a href="<?php echo e(url('account-en')); ?>" target="_blank" class="megamenu-image black">
                                      <img src="<?php echo e(URL::asset('assets/images/walpapers/comprar.gif')); ?>" alt="Image name" class="image">
                    ...
                    <div class="navbar-nav navbar-action">
                      <div class="nav-item">
                        <a href="<?php echo e(url('account-en')); ?>" target="_blank" class="button small-button rounded primary-15 primary-hover button-collision">
            ...
            <div class="row">
              <div class="col-12 col-lg-3 align-v-center d-only-desktop">
                ...
                <div class="image-wrapper p-2">
                  <img src="<?php echo e(URL::asset('assets/images/walpapers/c-1.png')); ?>" alt="Image name" class="image floating-item" />
                </div>
              </div>
              ...
              <div class="col-12 col-lg-3 align-v-center">
                <!-- Image -->
                <div class="image-wrapper p-2">
                  <img src="<?php echo e(URL::asset('assets/images/walpapers/c-2.png')); ?>" alt="Image name" class="image floating-item" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-12 col-md-6 col-lg-3" data-aos="zoom-in-up" data-aos-delay="200">
              <div class="card hover-up">
                <div class="card-body small-shadow rounded-3 bg-color white">
                  ...
                  <p class="description">Native application on both IOS and Android.</p>
                  <!-- Link -->
            ...
            <div class="col-12 col-md-6 col-lg-3" data-aos="zoom-in-up" data-aos-delay="400">
              <div class="card hover-up">
                <div class="card-body small-shadow rounded-3 bg-color white">
                  ...
                  <p class="description">Edit, delete or create systems in real time.</p>
                  <!-- Link -->
                  <a href="#your-link" class="full-link"></a>
                </div>
              </div>
            ...
            <div class="col-12 col-md-6 col-lg-3" data-aos="zoom-in-up" data-aos-delay="800">
              <div class="card hover-up">
                <div class="card-body small-shadow rounded-3 bg-color white">
                  ...
                  <p class="description">Total protection in your databases.</p>
                  <!-- Link -->
                  <a href="#your-link" class="full-link"></a>
                </div>
              </div>
          ...
          <div class="row g-4">
              ...
              <div class="holder">
                ...
                <div class="basic-intro">
                  ...
                  <div class="description gray">
                    ...
                    <p>To connect the brand with the target audience, it is necessary to observe each shape, color, font and style that will compose a subconscious message.</p>
                  </div>
                </div>
                <hr class="gray-25">
            ...
            <div class="col-12 col-md-5">
              ...
              <div class="image-wrapper" data-lax="inertia-top">
                <img src="<?php echo e(URL::asset('assets/images/walpapers/app.png')); ?>" class="image" alt="Image name" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="basic-intro mb-35 text-center">
            <h2 class="title black">
             ...
             <span class="text-2 text-style-6 text-italic"><mark class="animated-underline accent">join the future</mark>.</span>
            </h2>
                ...
                <div class="card-body rounded-bottom bg-color white">
                  ...
                  <ul class="checklist">
                    <li class="item">
                      ...
                      <img class="image-icon primary" src="<?php echo e(URL::asset('assets/svg/checkmark-outline.svg')); ?>" alt="Icon name" data-shock-icon="32" />
                    </li>
                    <li class="item">
                    ...
                    <li class="item">
                      ...
                      <img class="image-icon primary" src="<?php echo e(URL::asset('assets/svg/close-outline.svg')); ?>" alt="Icon name" data-shock-icon="32" />
                    </li>
                  </ul>
                  <!-- Button -->
                ...
                <div class="card-body rounded-bottom bg-color white">
                  ...
                  <div class="button-wrapper align-h-center hover-up-down">
                    <span class="button w-100 rounded secondary secondary-hover">
                      <span class="button-text white white-hover">Buy Fiwoo Enterprise</span>
                      <i class="fa-solid fa-arrow-right button-icon white white-hover"></i>
                    </span>
                  </div>
                </div>
                ...
                <div class="card-body rounded-bottom bg-color white">
                  ...
                  <div class="button-wrapper align-h-center hover-up-down">
                    <span class="button w-100 rounded tertiary tertiary-hover">
                      <span class="button-text white white-hover">Buy Fiwoo Premium</span>
                      <i class="fa-solid fa-arrow-right button-icon white white-hover"></i>
                    </span>
                  </div>
                </div>
          ...
          <div class="row g-3">
            <div class="col-12 col-md-6 col-lg-3">
              <div class="footer-item">
                ...
                <a href="<?php echo e(url('/')); ?>" class="footer-brand">
                  <img src="<?php echo e(URL::asset('assets/images/logo-white.svg')); ?>" alt="Shock Theme" class="logo" />
            ...
            <div class="col-12 col-md-6 col-lg-3">
              <div class="footer-item">
                ...
                <ul class="nav-list list-unstyled">
                  <li class="nav-item">
                    <a href="<?php echo e(url('fiwoo-app')); ?>" class="nav-link">
...
<?php /**PATH C:\xampp\htdocs\Management_System_App\fiwoo\resources\views/en.blade.php ENDPATH**/ ?>