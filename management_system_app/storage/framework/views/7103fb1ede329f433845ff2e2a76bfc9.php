<h1 class="text-center font-700 font-26 mt-3 pt-2">Compartir Fiwii</h1>
<p class="boxed-text-xl under-heading">
    Comparte nuestra página con el mundo
</p>
...
<div class="px-4">
    <div class="row text-center mb-0">
        ...
        <div class="col-3 mb-n2">
            ...
            <p class="font-11 opacity-70">Cerrar</p>
        </div>
    </div>
</div>

<?php /**PATH C:\xampp\htdocs\FCT-FIWII\management_system_app\resources\views/misc/menu-share.blade.php ENDPATH**/ ?>