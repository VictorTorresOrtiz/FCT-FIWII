...
<!--PWA READY---->
<link rel="manifest" href="<?php echo e(URL::asset('assets/manifest.json')); ?>" data-pwa-version="set_in_manifest_and_pwa_js">
                        ...
                        <div class="card bg-9" data-card-height="cover">
                            ...
                            <div class="card-bottom ms-4 me-4 mb-5">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a href="<?php echo e(url('/auth.login')); ?>" class=" btn-full btn btn-m bg-highlight color-white rounded-sm font-900 text-uppercase scale-box">Acceder</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-overlay bg-theme opacity-95"></div>
            ...
            <div class="splide__track">
                <div class="splide__list">
                    <div class="splide__slide">
                        <div class="card bg-9" data-card-height="cover">
                            <div class="card-center text-center">
                                <h1 class="fa-4x color-theme font-900">Bienvenido <?php echo e(Auth::user()->name); ?></h1>
                                <h4 class="font-300 color-highlight">Pulse el botón para acceder a Fiwii</h4>
                            </div>
                            <div class="card-bottom ms-4 me-4 mb-5">
                                <div class="row">
                                    <div class="col-6">
                                        <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn-full btn btn-m btn-border border-highlight color-highlight rounded-sm font-900 text-uppercase">Cerrar Sesión</a>
                                        <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="d-none">
                                            <?php echo csrf_field(); ?>
                                        </form>
                                    </div>
                                    <div class="col-6">
                                        <a href="<?php echo e(url('/fiwii')); ?>" class=" btn-full btn btn-m bg-highlight color-white rounded-sm font-900 text-uppercase scale-box">Acceder</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-overlay bg-theme opacity-95"></div>
...
<?php /**PATH C:\xampp\htdocs\FCT-FIWII\management_system_app\resources\views/index.blade.php ENDPATH**/ ?>