<div class="menu-header">
    ...
    <a href="<?php echo e(url('conf')); ?>" class="border-right-0"><i class="fa font-12 color-blue-dark fa-cog"></i></a>
    <a href="#" class="close-menu border-right-0"><i class="fa font-12 color-red-dark fa-times"></i></a>
</div>

<div class="menu-logo text-center">
    <a href="#"><img class="rounded-circle bg-highlight" width="80" src="<?php echo e(URL::asset('assets/images/avatars/5s.png')); ?>"></a>
    <h1 class="pt-3 font-800 font-28 text-uppercase"><?php echo e(Auth::user()->name); ?></h1>
...
<div class="menu-items mb-4">
    ...
    <a id="nav-welcome" href="<?php echo e(url('fiwii')); ?>">
    ...
    <a id="nav-starters" href="<?php echo e(url('profile')); ?>">
        <i class="bi bi-list-nested"></i>
        <span>Perfil</span>
        <i class="fa fa-circle"></i>
    </a>
    <a id="nav-starters" href="<?php echo e(url('to-do')); ?>">
        <i class="bi bi-list-nested"></i>
        <span>Trabajo</span>
        <i class="fa fa-circle"></i>
    </a>
...
<?php /**PATH C:\xampp\htdocs\FCT-FIWII\management_system_app\resources\views/misc/menu.blade.php ENDPATH**/ ?>