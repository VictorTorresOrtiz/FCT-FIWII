...
<title>Fiwii - Configuración</title>
...
<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/css/highlights/highlights/red.css')); ?>">
...
<!--PWA READY---->
<link rel="manifest" href="<?php echo e(URL::asset('assets/_manifest.json')); ?>" data-pwa-version="set_in_manifest_and_pwa_js">
...
<div id="page">
    ...
    <div class="header header-fixed header-auto-show header-logo-app">
        <a href="<?php echo e(url('fiwii')); ?>" class="header-title"></a>
        <a href="#" data-back-button class="header-icon header-icon-1"><i class="fas fa-arrow-left"></i></a>
    </div>
    <div id="footer-bar" class="footer-bar-5">
        <a href="<?php echo e(url('profile')); ?>"><i class="bi bi-person"></i><span>Perfil</span></a>
        <a href="<?php echo e(url('to-do')); ?>"><i class="bi bi-list-nested"></i></i><span>Trabajo</span></a>
        <a href="<?php echo e(url('fiwii')); ?>"><i class="bi bi-house"></i><span>Home</span></a>
        <a href="#"><i class="bi bi-upc-scan"></i><span>QR</span></a>
        <a href="<?php echo e(url('conf')); ?>" class="active-nav"><i class="bi bi-gear"></i><span>Configuración</span></a>
    </div>

    <div class="page-content">

        <div class="page-title page-title-small">
            <h2><a href="<?php echo e(url('fiwii')); ?>" data-back-button><i class="fa fa-arrow-left"></i></a>Configuración</h2>
            <a href="#" data-menu="menu-main" class="bg-fade-highlight-light shadow-xl preload-img" data-src="<?php echo e(URL::asset('assets/images/avatars/5s.png')); ?>"></a>
        </div>
    ...
    <div id="menu-share"
         ...
         data-menu-load="<?php echo e(url('misc.menu-share')); ?>"
    ...
    <div id="menu-main"
         ...
         data-menu-width="260"
         data-menu-load="<?php echo e(url('misc.menu')); ?>"
    ...
    <div id="menu-language" class="menu menu-box-bottom menu-box-detached rounded-m"
        ...
        <div class="me-3 ms-3 mt-3">
            ...
            <div class="list-group list-custom-small">
                <a href="#"><img class="me-3 mt-n1" width="20" src="<?php echo e(URL::asset('assets/images/flags/United-States.png')); ?>"><span>Inglés</span><i class="fa fa-angle-right"></i></a>
            </div>
            <div class="clear"></div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\FCT-FIWII\management_system_app\resources\views/conf.blade.php ENDPATH**/ ?>