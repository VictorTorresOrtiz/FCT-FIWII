...
<div id="page">
    ...
    <div id="footer-bar" class="footer-bar-5">
        <a href="<?php echo e(url('profile')); ?>" class="active-nav"><i class="bi bi-person"></i><span>Perfil</span></a>
    ...
    <div class="page-content">
        ...
        <div class="card header-card shape-rounded" data-card-height="150">
            ...
            <div class="card-bg preload-img" data-src="<?php echo e(URL::asset('images/pictures/20s.jpg')); ?> "></div>
        </div>
        ...
        <div class="card card-style">
            <div class="content mb-0">
                ...
                <div class="input-style has-borders hnoas-icon input-style-always-active validate-field mb-4">
                    <input id="name" type="text" placeholder="Usuario" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <input id="Plan" type="text" name="Plan" value="<?php echo e(Auth::user()->Plan); ?>" style="display: none">
...
<?php /**PATH C:\xampp\htdocs\FCT-FIWII\management_system_app\resources\views/profile.blade.php ENDPATH**/ ?>