...
<div id="page">
   ...
   <div class="header header-fixed header-auto-show header-logo-app">
    ...
    <div id="footer-bar" class="footer-bar-5">
        ...
        <a href="<?php echo e(url('to-do')); ?>"  class="active-nav"><i class="bi bi-list-nested"></i></i><span>Trabajo</span></a>
...
<?php /**PATH C:\xampp\htdocs\FCT-FIWII\management_system_app\resources\views/to-do.blade.php ENDPATH**/ ?>