<div class="footer card card-style mx-0 mb-0">
    <a href="#" class="footer-title pt-4">Fiwii</a>
    <p class="text-center font-12 mt-n1 mb-3 opacity-70">
        The Future <span class="color-highlight">is now</span>
    </p>
    <p class="boxed-text-l">
        Aplicación orientada a la gestión de equipos contra incendios.
    </p>
    ...
    <p class="footer-copyright pb-3 mb-1">Copyright &copy; Fiwii <span id="copyright-year">2023</span>. All Rights Reserved.</p>
</div>
<div class="footer-card card shape-rounded bg-20" style="height:230px">
    <div class="card-overlay bg-highlight opacity-90"></div>
</div>
<?php /**PATH C:\xampp\htdocs\FCT-FIWII\management_system_app\resources\views/misc/menu-footer.blade.php ENDPATH**/ ?>