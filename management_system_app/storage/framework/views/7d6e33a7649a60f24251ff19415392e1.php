...
<div id="page">
    ...
    <div class="header header-fixed header-auto-show header-logo-app">
        ...
        <a href="<?php echo e(url('conf')); ?>" class="header-icon header-icon-3"><i class="fa-solid fa-gear fa-spin"></i></a>
    </div>
    <div id="footer-bar" class="footer-bar-5">
        ...
        <a href="<?php echo e(url('fiwii')); ?>" class="active-nav"><i class="bi bi-house"></i><span>Home</span></a>
        <a href="#"><i class="bi bi-upc-scan"></i><span>QR</span></a>
        <a href="<?php echo e(url('conf')); ?>"><i class="bi bi-gear"></i><span>Configuración</span></a>
    </div>

    <div class="page-content">

        <div class="page-title page-title-large">
            <h2 data-username='<?php echo e(Auth::user()->name); ?>' class="greeting-text"></h2>
        ...
        <div class="footer" data-menu-load="<?php echo e(url('misc.menu-footer')); ?>"></div>
    </div>
    <!-- end of page content-->
    ...
    <div id="menu-install-pwa-android" class="menu menu-box-bottom menu-box-detached rounded-l" data-menu-height="350" data-menu-effect="menu-parallax">
        <div class="boxed-text-l mt-4">
            <img class="rounded-l mb-3" src="<?php echo e(URL::asset('assets/images/logo.png')); ?>" alt="img" width="90">
    ...
    <div id="menu-install-pwa-ios"
        ...
        <div class="boxed-text-xl mt-4">
            <img class="rounded-l mb-3" src="<?php echo e(URL::asset('assets/app/icons/icon-128x128.png')); ?>" alt="img" width="90">
            <h4 class="mt-3">Fiwii en su pantalla de Inicio</h4>
            <p class="mb-0 pb-3">
...
<?php /**PATH C:\xampp\htdocs\FCT-FIWII\management_system_app\resources\views/fiwii.blade.php ENDPATH**/ ?>