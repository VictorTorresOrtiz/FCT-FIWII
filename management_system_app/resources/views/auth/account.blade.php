                    ...
                    <div class="content mt-2 mb-0">
                        <div class="input-style no-borders has-icon validate-field mb-4">
                            ...
                            <input id="name" type="name" class="form-control validate-name"
                                @error('name') is-invalid @enderror placeholder="Usuario"
                                @error('user') is-invalid @enderror name="name" value="{{ old('name') }}"
                        ...
                        <div class="input-style no-borders has-icon validate-field mb-4">
                            ...
                            <input id="password" type="password" class="form-control validate-password"
                                @error('password') is-invalid @enderror id="form3a" placeholder="Contraseña"
                        ...
                        <button type="submit" class="btn btn-m mt-4 mb-4 btn-full bg-fade-highlight-dark rounded-sm text-uppercase font-900">{{ __('Acceder') }}
                        </button>
