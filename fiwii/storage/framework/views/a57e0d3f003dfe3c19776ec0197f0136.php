              ...
              <div class="row g-4">
                <div class="col-12 col-md-6 col-lg-4" data-aos="zoom-in-up" data-aos-delay="200">
                  <div class="card has-price rounded shadow parent">
                    ...
                    <!-- Link -->
                    <a href="<?php echo e(url('plans.basic')); ?>" class="full-link"></a>
                  </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4" data-aos="zoom-in-up" data-aos-delay="400">
                  <div class="card has-price rounded shadow parent">
                    ...
                    <!-- Link -->
                    <a href="<?php echo e(url('plans.enterprise')); ?>" class="full-link"></a>
                  </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4" data-aos="zoom-in-up" data-aos-delay="600">
                  <div class="card has-price rounded shadow parent">
                    ...
                    <!-- Link -->
                    <a href="<?php echo e(url('plans.premium')); ?>" class="full-link"></a>
                  </div>
                </div>
              </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Management_System_App\fiwii\resources\views/index.blade.php ENDPATH**/ ?>