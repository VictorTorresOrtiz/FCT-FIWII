                    ...
                    <form class="form-fields needs-validation" novalidate="novalidate">
                      <div class="form-row row has-icon">
                        <div class="form-col form-floating">
                          ...
                          <input id="InputSearchMenu" class="form-control focus-trigger-field" placeholder="Buscador..." required="required">
      ...
      <section id="home" class="shock-section dynamic-slider scheme-1" data-autoplay="10000">
        ...
        <div class="slide-info-menu parent">
          <div id="slide-info-toggle" class="slide-info-toggle">
            <span class="arrow-button cross scheme-2 primary">
              ...
              <span class="line"></span>
              <a href="#home" id="slide-info-toggle-text" class="text" data-toggle="Ver menos">Ver más</a>
            </span>
          </div>
        ...
        <div class="slide-item side-intro current-slide">
          ...
          <div class="slide-content">
            ...
            <div class="slide-description">
              <span class="text-2 text-style-3 text-italic black">nuestra app <mark class="animated-underline primary-50">gratis</mark> !</span>
              <div class="description gray">
                <p>Si todavía no te has decido a adquirir Fiwii puedes probar de forma gratuita nuestra Aplicación.</p>
              </div>
            </div>
          </div>
          <!-- Image -->
          <div class="slide-image-wrapper">
            <div class="slide-image-inner">
              <img src="{{ URL::asset('assets/images/trial/01.gif') }}" alt="Image name" class="slide-image bg-color primary-50" />
            </div>
          </div>
           <!-- Action -->
        ...
        <div class="slide-item side-intro">
          ...
          <div class="slide-content">
            ...
            <div class="slide-description">
              <span class="text-2 text-style-3 text-italic black">Unete al <mark class="animated-underline secondary-50">futuro</mark> !</span>
              <div class="description gray">
          ...
          <div class="slide-image-wrapper">
            <div class="slide-image-inner">
              <img src="{{ URL::asset('assets/images/trial/02.gif') }}" alt="Image name" class="slide-image bg-color secondary-50" />
            </div>
          </div>
          <!-- Action -->
          <div class="slide-action">
        ...
        <div class="slide-item side-intro">
          ...
          <div class="slide-content">
            ...
            <div class="slide-description">
              <span class="text-2 text-style-3 text-italic black">nuestro <mark class="animated-underline tertiary-50">portfolio</mark> !</span>
              <div class="description gray">
                <p>Tenemos siempre presente la necesidad de mejorar todo lo que hacemos, con el objetivo de ayudar a las personas con nuestros productos y servicios, priorizando la calidad.</p>
              </div>
            </div>
          </div>
          <!-- Image -->
          ...
          <div class="modal-header">
            ...
            <div class="basic-intro">
              <h2 class="title black">
                ...
                <span class="text-2 text-style-8 text-italic"> <mark class="animated-underline primary-50">ayudarte</mark>?</span>
              </h2>
              <div class="description gray">
              ...
              <form action="#" class="form-fields needs-validation ajax-form" novalidate="novalidate">
                <div class="form-row row">
                  <div class="form-col form-floating col-12 col-md-6">
                    <input type="text" name="name" id="InputModalName" class="form-control" placeholder="Nombre" required="required">
                ...
                <div class="form-row row">
                  <div class="form-col form-floating col-12">
                    <textarea name="message" id="InputModalMessage" class="form-control form-textarea" rows="3" placeholder="Mensaje"></textarea>
